    ...
    public OpenAPI adminServiceOpenAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("REST API for the Arya Banking Admin Service — Vault AppRole management, Keycloak realm administration, HCL policy management, and infrastructure automation.")
                        .version("1.0.0"))
                .servers(List.of(
